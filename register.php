<main>
    <div class="flex">
        ...
        <?php if(!empty($_SESSION['fnUserId'])){ die('<script>alert("이미 로그인 되어있습니다!");history.back()</script>'); } ?>
                ...
                <div class="row">
                    ...
                    <div class="card">
                        ...
                        <section>
                            ...
                            <input type="email" name="mail" placeholder="ex) abc@def.xyz" aria-label="Email" required>
                        </section>
                        <footer>
